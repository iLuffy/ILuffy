...
<configurationSectionModel xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="dee4848e-76d3-4a77-b8d8-e6706f84d49f" namespace="ILuffy.Core" xmlSchemaNamespace="urn:ILuffy.Core" xmlns="http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner">
  ...
  <configurationElements>
    <configurationSection name="ILuffyConfig" namespace="ILuffy.IOP" codeGenOptions="Singleton, XmlnsProperty" xmlSectionName="iLuffyConfig">
      <elementProperties>
    ...
    <configurationElement name="InstanceElement" namespace="ILuffy.IOP">
      <attributeProperties>
    ...
    <configurationElementCollection name="InstanceCollection" namespace="ILuffy.IOP" xmlItemName="instanceElement" codeGenOptions="Indexer, AddMethod, RemoveMethod, GetItemMethods">
      <itemType>
